...
class Apartar(models.Model):
    ...
    estado = models.IntegerField(db_column='estado', blank=True, null=False)
    class Meta:
        managed = False
        db_table = 'Apartar'
...
class Venta(models.Model):
    ...
    class Meta:
        ...
        db_table = 'Venta'
    def __str__(Venta):
        return str(Venta.idVenta)

class DetalleVenta(models.Model):
    #idDetalleVenta = models.BigAutoField(db_column='idDetalleVenta', primary_key=True, null=False, blank=True)
    idVenta = models.ForeignKey('Venta',models.DO_NOTHING,db_column='idVenta', primary_key=True, blank=True, null=False)
    idCliente = models.ForeignKey('Cliente',models.DO_NOTHING,db_column='idCliente', blank=True, null=False)
    idAr = models.ForeignKey('Articulo',models.DO_NOTHING,db_column='idAr', blank=True, null=False)
    cantidadA = models.IntegerField(db_column='cantidadA', blank=True, null=False)
    precioAr = models.IntegerField(db_column='precioAr', blank=True, null=False)
    fechadetalle = models.IntegerField(db_column='fechadetalle', blank=True, null=False)
    class Meta:
        managed = False
        db_table = 'DetalleVenta'
    def __str__(DetalleVenta):
        return str(DetalleVenta.idVenta) 
...
class Abono(models.Model):
    ...
    fecha = models.CharField(db_column='fecha',max_length=10, blank=True, null=False)
    class Meta:
        managed = False
        db_table = 'Abono'
